...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.password_reset'
        db.add_column(u'supervisor_user', 'password_reset',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.password_reset'
        db.delete_column(u'supervisor_user', 'password_reset')
    ...
    models = {
        ...
        u'supervisor.user': {
            ...
            'password_reset': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
