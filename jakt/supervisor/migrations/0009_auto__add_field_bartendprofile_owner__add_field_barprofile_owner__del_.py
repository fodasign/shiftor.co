...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BartendProfile.owner'
        db.add_column(u'supervisor_bartendprofile', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['supervisor.User']),
                      keep_default=False)

        # Adding field 'BarProfile.owner'
        db.add_column(u'supervisor_barprofile', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['supervisor.User']),
                      keep_default=False)

        # Deleting field 'User.bar_profile'
        db.delete_column(u'supervisor_user', 'bar_profile_id')

        # Deleting field 'User.bartend_profile'
        db.delete_column(u'supervisor_user', 'bartend_profile_id')


    def backwards(self, orm):
        # Deleting field 'BartendProfile.owner'
        db.delete_column(u'supervisor_bartendprofile', 'owner_id')

        # Deleting field 'BarProfile.owner'
        db.delete_column(u'supervisor_barprofile', 'owner_id')

        # Adding field 'User.bar_profile'
        db.add_column(u'supervisor_user', 'bar_profile',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['supervisor.BarProfile'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'User.bartend_profile'
        db.add_column(u'supervisor_user', 'bartend_profile',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['supervisor.BartendProfile'], null=True, blank=True),
                      keep_default=False)
