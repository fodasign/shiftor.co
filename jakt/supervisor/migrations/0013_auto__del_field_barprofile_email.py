...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BarProfile.email'
        db.delete_column(u'supervisor_barprofile', 'email')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'BarProfile.email'
        raise RuntimeError("Cannot reverse this migration. 'BarProfile.email' and its values cannot be restored.")
