...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BarProfile.address_2'
        db.delete_column(u'supervisor_barprofile', 'address_2')


    def backwards(self, orm):
        # Adding field 'BarProfile.address_2'
        db.add_column(u'supervisor_barprofile', 'address_2',
