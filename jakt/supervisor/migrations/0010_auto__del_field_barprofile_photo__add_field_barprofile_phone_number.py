...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BarProfile.photo'
        db.delete_column(u'supervisor_barprofile', 'photo')

        # Adding field 'BarProfile.phone_number'
        db.add_column(u'supervisor_barprofile', 'phone_number',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'BarProfile.photo'
        raise RuntimeError("Cannot reverse this migration. 'BarProfile.photo' and its values cannot be restored.")
        # Deleting field 'BarProfile.phone_number'
        db.delete_column(u'supervisor_barprofile', 'phone_number')
