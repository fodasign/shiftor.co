...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BartendProfile.phone_number'
        db.alter_column(u'supervisor_bartendprofile', 'phone_number', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'BartendProfile.phone_number'
        raise RuntimeError("Cannot reverse this migration. 'BartendProfile.phone_number' and its values cannot be restored.")
