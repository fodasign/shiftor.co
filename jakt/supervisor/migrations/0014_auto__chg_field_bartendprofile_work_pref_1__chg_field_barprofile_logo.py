...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BartendProfile.work_pref_1'
        db.alter_column(u'supervisor_bartendprofile', 'work_pref_1', self.gf('django.db.models.fields.CharField')(default='Bartender', max_length=255))

        # Changing field 'BarProfile.logo'
        db.alter_column(u'supervisor_barprofile', 'logo', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'BartendProfile.work_pref_1'
        db.alter_column(u'supervisor_bartendprofile', 'work_pref_1', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # User chose to not deal with backwards NULL issues for 'BarProfile.logo'
        raise RuntimeError("Cannot reverse this migration. 'BarProfile.logo' and its values cannot be restored.")
    ...
    models = {
        ...
        u'supervisor.barprofile': {
            ...
            'card_4': ('django.db.models.fields.CharField', [], {'max_length': '4', 'null': 'True', 'blank': 'True'}),
            'city': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'customer_id': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
        ...
        u'supervisor.bartendprofile': {
            ...
            'work_pref_1': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
