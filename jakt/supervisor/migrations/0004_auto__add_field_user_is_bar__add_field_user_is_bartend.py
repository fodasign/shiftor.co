...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.is_bar'
        db.add_column(u'supervisor_user', 'is_bar',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'User.is_bartend'
        db.add_column(u'supervisor_user', 'is_bartend',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.is_bar'
        db.delete_column(u'supervisor_user', 'is_bar')

        # Deleting field 'User.is_bartend'
        db.delete_column(u'supervisor_user', 'is_bartend')
