...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BarProfile.customer_id'
        db.add_column(u'supervisor_barprofile', 'customer_id',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BarProfile.card_4'
        db.add_column(u'supervisor_barprofile', 'card_4',
                      self.gf('django.db.models.fields.CharField')(max_length=4, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BarProfile.customer_id'
        db.delete_column(u'supervisor_barprofile', 'customer_id')

        # Deleting field 'BarProfile.card_4'
        db.delete_column(u'supervisor_barprofile', 'card_4')
