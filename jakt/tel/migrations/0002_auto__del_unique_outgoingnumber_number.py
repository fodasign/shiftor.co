...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'OutgoingNumber', fields ['number']
        db.delete_unique(u'tel_outgoingnumber', ['number'])


    def backwards(self, orm):
        # Adding unique constraint on 'OutgoingNumber', fields ['number']
        db.create_unique(u'tel_outgoingnumber', ['number'])
    ...
    models = {
        ...
        u'tel.incomingnumber': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'XDAA32'", 'max_length': '255'}),
        ...
        u'tel.outgoingnumber': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'verification_code': ('django.db.models.fields.CharField', [], {'default': "'47HHEJ'", 'max_length': '8'}),
