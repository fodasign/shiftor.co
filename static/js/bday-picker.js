  ...
  $.fn.birthdaypicker = function( options ) {
    ...
    return this.each(function() {
      ...
      var $fieldset = $("<fieldset class='birthday-picker'></fieldset>"),
          $year = $("<select class='birth-year' name='birth[year]'></select><br>"),
          $month = $("<select class='birth-month' name='birth[month]'></select><br>"),
          $day = $("<select class='birth-day' name='birth[day]'></select><br>");
